...
let ShoppingListListDesign = createVisualComponent({
  //@@viewOn:statics
  uu5Tag: Config.TAG + "ShoppingListListDesign",
  //@@viewOff:statics
...
ShoppingListListDesign = withRoute(ShoppingListListDesign);

//@@viewOn:exports
export { ShoppingListListDesign };
export default ShoppingListListDesign;
//@@viewOff:exports
