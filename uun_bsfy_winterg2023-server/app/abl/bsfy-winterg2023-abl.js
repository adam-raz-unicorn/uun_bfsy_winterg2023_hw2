...
const Errors = require("../api/errors/bsfy-winterg2023-error.js");
...
const logger = LoggerFactory.get("BsfyWinterg2023Abl");

class BsfyWinterg2023Abl {
  constructor() {
...
module.exports = new BsfyWinterg2023Abl();
